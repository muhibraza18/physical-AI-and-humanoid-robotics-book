...
const config = {
  ...
  tagline: 'A Definitive University-Level Reference',
  ...
  url: 'https://muhibraza18.github.io',
  ...
  themeConfig:
    ...
    ({
        ...
        links: [
          {
            ...
            items: [
              {
                label: 'Chapters',
                to: '/docs/chapter-01', // Link to first chapter
              },
            ],
          },
          {
      ...
      prism: {
        theme: prismThemes.vsDark, // Using a dark theme for code blocks by default
        darkTheme: prismThemes.dracula, // Another dark theme for dark mode
        additionalLanguages: ['json', 'bash', 'python', 'cpp', 'css', 'yaml', 'markdown'], // Add relevant languages
      },
    }),
};
